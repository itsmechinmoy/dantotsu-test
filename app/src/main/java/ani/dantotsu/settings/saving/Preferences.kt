...
enum class PrefName(val data: Pref) {
    ...
    DLNAEnabled(Pref(Location.Player, Boolean::class, false)),
    DLNAFriendlyName(Pref(Location.Player, String::class, "Dantotsu")),
    DLNAEnableIPv6(Pref(Location.Player, Boolean::class, false)),
    DLNADisableUPNP(Pref(Location.Player, Boolean::class, false)),
