...
enum class PrefName(val data: Pref) {
    ...
    SmallerTapZones(Pref(Location.Reader, Boolean::class, false)),
    ForcedHorizontalSeekbar(Pref(Location.Reader, Boolean::class, false)),
    ShowVerticalSeekbarInLandscape(Pref(Location.Reader, Boolean::class, false)),
    LeftHandedVerticalSeekbar(Pref(Location.Reader, Boolean::class, false)),
    DefaultRotation(Pref(Location.Reader, Int::class, 0)),
    ReaderBackgroundColor(Pref(Location.Reader, Int::class, 0)),
    EInkFlashPageChange(Pref(Location.Reader, Boolean::class, false)),
    SkipChaptersMarkedRead(Pref(Location.Reader, Boolean::class, false)),
    SkipFilteredChapters(Pref(Location.Reader, Boolean::class, false)),
    AlwaysShowChapterTransition(Pref(Location.Reader, Boolean::class, false)),
    PagedTapZones(Pref(Location.Reader, Int::class, 0)),
    InvertTapZones(Pref(Location.Reader, Int::class, 0)),
    PagedScaleType(Pref(Location.Reader, Int::class, 0)),
    ZoomStartPosition(Pref(Location.Reader, Int::class, 0)),
    SplitWidePages(Pref(Location.Reader, Boolean::class, false)),
    RotateWidePagesToFit(Pref(Location.Reader, Boolean::class, false)),
    SmartScaleWideScreen(Pref(Location.Reader, Int::class, 0)),
    ContinuousSidePadding(Pref(Location.Reader, Int::class, 0)),
    MenuHidingSensitivity(Pref(Location.Reader, Int::class, 0)),
    PagePreloadAmount(Pref(Location.Reader, Int::class, 1)),
    DownloadThreads(Pref(Location.Reader, Int::class, 2)),
    ReaderCacheSize(Pref(Location.Reader, Int::class, 100)),
    LanczosUpscale(Pref(Location.Reader, Boolean::class, false)),
    SharpenStrength(Pref(Location.Reader, Float::class, 0.0f)),
